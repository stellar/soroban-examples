...
const ALPHA_X: &str =
    "20586411654224940726121807510656854616919838017362192913325723364246767479247";
const ALPHA_Y: &str =
    "14406135834237420410898393224422728106845847411380780163009899508656542500674";

const BETA_X1: &str =
    "10455785418957748805112801769878863871439287287746407726187317727278729655393";
const BETA_X2: &str =
    "7994732166366626571659429762957445732500444789770753725565126434770874060445";
const BETA_Y1: &str =
    "6171554364750907305893121967664455952867276595633237025381859103793190603186";
const BETA_Y2: &str =
    "1068707785281839727180321966526799350627265679563357300928626073084686493834";
...
const DELTA_X1: &str =
    "9728641619599932167558405925032483286291264581149582657399819891409232109311";
const DELTA_X2: &str =
    "19241695161990167743108773954643056384459332112654898578100132363962975297059";
const DELTA_Y1: &str =
    "14077793321404315919939614415644656852218893964079974656696758780514393147506";
const DELTA_Y2: &str =
    "477138352543384316457862019198400223292705943523596124653136815176264865609";
...
const PI_A_X: &str =
    "15056319861143982370511851795100655862674952298862168185142634150526446898932";
const PI_A_Y: &str =
    "20524016742028017914278639014573029696397580893761136931992899239091515061583";
const PI_B_X1: &str =
    "1739426650003613298637521076298027612785708580102733347125679950635649770676";
const PI_B_X2: &str =
    "2964793715073763051183683532836939129978676824115763049942969571484972008340";
const PI_B_Y1: &str = "231714500818561961964881885199979457754178468650240635167721171785635224632";
const PI_B_Y2: &str =
    "16949586399773881191905677229599029076778019197530892858153210038293513748836";
const PI_C_X: &str =
    "19305753993632836293634613984434718007247114328469217861805683289168510519612";
...
mod groth16_verifier_contract {
    soroban_sdk::contractimport!(file = "../opt/soroban_groth16_verifier_bn254.wasm");
}
