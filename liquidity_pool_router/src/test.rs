...
fn test() {
    ...
    let router_id = Identifier::Contract(FixedBinary::from_array(&e, contract_router));
    ...
    let pool_id = Identifier::Contract(FixedBinary::from_array(&e, contract_pool.clone().into()));
