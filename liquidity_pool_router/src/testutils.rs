...
use soroban_token_contract::public_types::{Identifier, U256};
...
impl LiquidityPoolRouter {
    ...
    pub fn swap_out(
        ...
        let sell = FixedBinary::from_array(&self.env, *sell);
        let buy = FixedBinary::from_array(&self.env, *buy);
    ...
    pub fn get_pool(&self, token_a: &[u8; 32], token_b: &[u8; 32]) -> U256 {
        let token_a = FixedBinary::from_array(&self.env, *token_a);
        let token_b = FixedBinary::from_array(&self.env, *token_b);
