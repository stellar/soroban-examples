...
impl CommandHandler {
    ...
    pub fn handle_generate(&self, scope: String, output: String) -> Result<()> {
        ...
        debug!("Generated coin commitment: {}", generated_coin.commitment_hex);
    ...
    pub fn handle_withdraw(
        ...
        let withdrawal_json = self.serialization_manager.serialize_snark_input(&snark_input)?;
    ...
    pub fn handle_update_association(&self, association_file: String, label: String) -> Result<()> {
        ...
        self.association_manager.update_association_set(&env, &association_file, &label)?;
