...
fn init_pub_signals(env: &Env) -> Bytes {
    let public_0 = U256::from_be_bytes(
        ...
        &Bytes::from_array(
            &env,
            &[
                0x60, 0x1a, 0x57, 0x3e, 0x7c, 0x20, 0x81, 0x0f, 0xc5, 0x10, 0xf2, 0x51, 0xc5, 0x2f,
                0x99, 0xa5, 0xf9, 0x35, 0x84, 0xf7, 0x07, 0x47, 0xf5, 0xee, 0x84, 0xdf, 0x5d, 0xb4,
                0x48, 0x2e, 0x9f, 0xe6,
            ],
        ),
    );
    ...
    let public_2 = U256::from_be_bytes(
        ...
        &Bytes::from_array(
            &env,
            &[
                0x45, 0xc3, 0x62, 0xdf, 0x5b, 0xdc, 0xaf, 0x41, 0x8a, 0x40, 0xe2, 0x7c, 0xf5, 0x9c,
                0x8f, 0x71, 0x29, 0x45, 0xde, 0x9d, 0x17, 0x90, 0x4f, 0x16, 0xfb, 0xa8, 0xdc, 0x69,
                0xd1, 0x02, 0xd4, 0x08,
            ],
        ),
    );
    let public_3 = U256::from_be_bytes(
        ...
        &Bytes::from_array(
            &env,
            &[
                0x0c, 0x62, 0x9c, 0xe5, 0x84, 0xbe, 0xbb, 0xc0, 0xd7, 0x6e, 0x7a, 0x23, 0xbc, 0x66,
                0x7c, 0x57, 0xc7, 0xe9, 0xf2, 0xcb, 0x6f, 0x6d, 0xc9, 0x3f, 0xbd, 0xe9, 0x00, 0x68,
                0xb8, 0x2f, 0x74, 0xf6,
            ],
        ),
    ); // Association root
...
fn test_deposit_and_withdraw_correct_proof() {
    ...
    let commitment = BytesN::from_array(
        &env,
        &[
            0x5c, 0xd2, 0x32, 0x9b, 0x7b, 0xcc, 0x98, 0x1a, 0xea, 0xbb, 0xe6, 0x7f, 0xd2, 0xd1,
            0xca, 0x42, 0x5d, 0x35, 0x1f, 0xab, 0x7b, 0x17, 0x66, 0x7e, 0xef, 0x82, 0x93, 0x94,
            0x43, 0x51, 0x05, 0x74,
        ],
    );
...
fn test_reuse_nullifier() {
    ...
    // First deposit
    let commitment1 = BytesN::from_array(
        &env,
        &[
            0x5c, 0xd2, 0x32, 0x9b, 0x7b, 0xcc, 0x98, 0x1a, 0xea, 0xbb, 0xe6, 0x7f, 0xd2, 0xd1,
            0xca, 0x42, 0x5d, 0x35, 0x1f, 0xab, 0x7b, 0x17, 0x66, 0x7e, 0xef, 0x82, 0x93, 0x94,
